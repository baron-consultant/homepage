            ...
            <div class="popup_contents_wrap" data-lenis-prevent-wheel>
                <picture>
                    <source
                      ...
                      srcset="../assets/img/sv/m_${pageType}_${value}.jpg"
                    />
                    <source
                      media="(min-width: 1401px)"
                      srcset="../assets/img/sv/${pageType}_${value}.jpg"
                    />
                  <img src="../assets/img/sv/${pageType}_${value}.jpg">
                </picture>
            </div>
        ...
        <div class="popup_wrap op_more">
            <div class="popup_contents_wrap" data-lenis-prevent-wheel>
                ...
                <picture>
                    <source
                      media="(max-width:1400px)"
                      srcset="../assets/img/sv/m_${pageType}_op_more.jpg"
                    />
                    <source
                      media="(min-width: 1401px)"
                      srcset="../assets/img/sv/${pageType}_op_more.jpg"
                    />
                  <img src="../assets/img/sv/${pageType}_op_more.jpg">
                </picture>
              ...
              <div class="popup_contents">
                ...
                <div class="pop_body">
                  <div class="tit_box">
                    ...
                    <h2>?åÌîÑ?∏Ïõ®???¥Îãπ?êÏóêÍ≤?br><b>?¥Ïö©Î¨∏Ïùò Î©îÏùº??Î≥¥ÎÇ¥Ï£ºÏÑ∏??/b></h2>
                  </div>
                  <div class="txt_box">
                    <dl>
                        <dt>Î©îÏùºÏ£ºÏÜå</dt>
                        <dd><span class="email">baroncs@baroncs.co.kr</span> <button class="btn copy" onclick="btnCopy();"><span>Î≥µÏÇ¨</span><i></i></button></dd>
                    </dl>
                  </div>
                </div>
              </div>
