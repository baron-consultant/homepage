...
document.addEventListener('DOMContentLoaded', (event)=> {
    ...
    // 페이지 높이와 윈도우 높이를 계산하여 탑 버튼의 위치를 조정
    function adjustButtonPosition() {
        ...
        const bottomSpace = 280; // 탑 버튼이 아래에서 떨어져 있어야 하는 거리
    ...
    // 스크롤할 때마다 adjustButtonPosition 함수 호출
    window.addEventListener('scroll', adjustButtonPosition);

    // 페이지 로드 시에도 adjustButtonPosition 함수 호출
...
function agreement(){
    $(".popup_wrap").hide();    
    $('#pop_agreement').show(0, function(){$.getScript("../js/popup.js", 
	function(){handlePopupScroll();}
	);});     
};
...
function join(){
    $(".popup_wrap").hide();    
    $('#pop_join').show(0, function(){$.getScript("../js/popup.js", 
	function(){handlePopupScroll();}
	);});     
};
function login(){
    $(".popup_wrap").hide();    
    $('#pop_login').show(0, function(){$.getScript("../js/popup.js", 
	function(){handlePopupScroll();}
	);});     
};
...
function mypage01(){
    $(".popup_wrap").hide();    
    $('#pop_mypage01').show(0, function(){$.getScript("../js/popup.js", 
	function(){handlePopupScroll();}
	);});     
};
...
function mypage02(){
    $(".popup_wrap").hide();    
    $('#pop_mypage02').show(0, function(){$.getScript("../js/popup.js", 
	function(){handlePopupScroll();}
	);});     
};
...
function mypage03(){
    $(".popup_wrap").hide();    
    $('#pop_mypage03').show(0, function(){$.getScript("../js/popup.js", 
	function(){handlePopupScroll();}
	);});     
};
...
function search(){
    $(".popup_wrap").hide();    
    $('#pop_search').show(0, function(){$.getScript("../js/popup.js", 
	function(){handlePopupScroll();}
	);});     
};
...
function sitemap(){
    $(".popup_sitemap").hide();
    $('#sitemap').show(0, function(){$.getScript("../js/popup.js", 
	function(){handlePopupScroll();}
	);});     
};
