...
document.addEventListener('DOMContentLoaded', () => {
    ...
    mouseArea02.addEventListener('mouseleave', () => mouseMark02.style.display = 'none');
    
    mouseNot02.addEventListener('mouseover', () => mouseMark02.style.opacity = '0');
    mouseNot02.addEventListener('mouseleave', () => mouseMark02.style.opacity = '1');
});
